...
document_text = "But I must explain to you how all this mistaken idea of denouncing pleasure " \
...
# words_list = document_text.upper() \
#        .replace(".", " ") \
#        .replace(",", " ") \
#        .replace(";", " ") \
#        .replace(":", " ") \
...
print(top_10_words(document_text))
